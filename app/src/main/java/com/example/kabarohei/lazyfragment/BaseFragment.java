...
public abstract class BaseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        isInitView = true;
        lazyLoadData();
        LogUtil.i("isFirstLoad",String.valueOf(isFirstLoad)+this.getClass().getSimpleName());
        return convertView;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        LogUtil.m("  onViewCreated " + this.getClass().getSimpleName());
    }

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        LogUtil.m("onAttach" + "   " + this.getClass().getSimpleName());
    ...
    public void onStart() {
        super.onStart();
        LogUtil.m("onstart" + "   " + this.getClass().getSimpleName());
    }

    @Override
    public void onStop() {
        super.onStop();
        LogUtil.m(" onstop" + "   " + this.getClass().getSimpleName());
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        LogUtil.m("onDestroyView" + "   " + this.getClass().getSimpleName());
    }
}
